...
secrets. D1 migrations 0000–0026 are confirmed applied to prod (0021 dropped the `comments` table;
...
2026-08-17; 0026 added `project_comments`/`project_comment_mentions`, applied 2026-08-17) — next
available number is **0027**. Branch off `main`.
