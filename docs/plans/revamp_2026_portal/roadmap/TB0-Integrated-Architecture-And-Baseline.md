...
Turn the revised package into approved repository authority, matched prototype/current baseline, classified drift register, and reviewed implementation plans for the first foundational releases.

## Required work

- Re-read current `main`, AGENTS, authority docs, todo, lessons and orchestration policy.
- Run/document full pre-change gate.
...
- TB0A captures focused React 18/19 parity evidence.
- Accepted React 19.2 output becomes TB1 baseline.
- Later Calendar/External Editor evidence is added by their owning bullets, not fabricated during TB0.
