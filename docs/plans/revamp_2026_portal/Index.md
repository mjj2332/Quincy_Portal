...
**Detailed folder:** [`revamp_2026_portal/`](./README.md)
...
2. Read the [high-level brief](./Brief.md) and [decision register](./core/01-Decision-Register.md) as proposal context, not as proof that a feature is live.
...
|---|---|
| Owner reviewing scope and direction | [Brief](./Brief.md) → [Decision register](./core/01-Decision-Register.md) → [PRD delta](./core/03-PRD-Delta.md) |
| Agent drafting the umbrella/authority update | Current [Decision Sheet](../../Decision-Sheet.md) → [Implementation Plan](../../Implementation-Plan.md) → [PRD](../../PRD.md) → [Package README](./README.md) → [Current-state audit](./core/02-Current-State-Audit.md) → [Roadmap](./roadmap/README.md) → [Document update map](./core/10-Repository-Document-Update-Map.md) |
| AutoHDR explicit send, Editing Stage, jobs, or notifications | Current [Implementation Plan](../../Implementation-Plan.md) → current [PRD](../../PRD.md) → [Current-state audit](./core/02-Current-State-Audit.md) → [Route/data freshness](./core/05-Route-And-Data-Freshness.md) → [Notification architecture](./core/07-Notifications-On-Cloudflare.md) → [Kanban/stage architecture](./core/08-Kanban-Modernization.md) → [Migration/verification](./core/09-Migration-Rollback-And-Verification.md) |
| React 19.2 runtime upgrade | [Frontend architecture](./core/04-Frontend-Architecture.md) → [Migration/verification](./core/09-Migration-Rollback-And-Verification.md) → [TB0A](./roadmap/TB0A-React-19-2-Runtime-Upgrade.md) |
| Admin pipeline boundary | [Decision register](./core/01-Decision-Register.md) → [Kanban/stage architecture](./core/08-Kanban-Modernization.md) → [TB0B](./roadmap/TB0B-Pipeline-Configuration-Boundary.md) |
| Tailwind/shadcn or UI convergence | [Design convergence](./core/11-Design-Convergence.md) → [Frontend architecture](./core/04-Frontend-Architecture.md) → [UI research](./research/UI-Stack-Tailwind-Shadcn.md) → [TB1](./roadmap/TB1-Tailwind-Shadcn-Foundation.md) or [TB8](./roadmap/TB8-Wider-UI-Migration-And-Cleanup.md) |
| Automatic refresh, routing, multi-tab behavior | [Route/data freshness](./core/05-Route-And-Data-Freshness.md) → [TB2](./roadmap/TB2-Route-Safe-Data-Freshness.md) |
| Project discussion/read state | [Discussion architecture](./core/06-Discussions-And-Notice-Board.md) → [TB3](./roadmap/TB3-Project-Discussion-V2.md) |
| Notification reliability | [Notification architecture](./core/07-Notifications-On-Cloudflare.md) → [TB4](./roadmap/TB4-Notification-Outbox-And-Queues.md) |
| Project Workspace team assignment | [PRD delta](./core/03-PRD-Delta.md) → [Current-state audit](./core/02-Current-State-Audit.md) → [TB4A](./roadmap/TB4A-Project-Workspace-Assignment-Rail.md) |
| Project Deadline/reminders or Kanban due metadata | [PRD delta](./core/03-PRD-Delta.md) → [Notification architecture](./core/07-Notifications-On-Cloudflare.md) → [TB4B](./roadmap/TB4B-Project-Deadline-And-Reminders.md) |
| Editor-wide project-change alerts | [PRD delta](./core/03-PRD-Delta.md) → [Notification architecture](./core/07-Notifications-On-Cloudflare.md) → [TB4C](./roadmap/TB4C-Editor-Wide-Project-Change-Notifications.md) |
| Checklist start/end scheduling | [Scheduling architecture](./core/12-Production-Calendar-And-Checklist-Scheduling.md) → [Notification architecture](./core/07-Notifications-On-Cloudflare.md) → [TB4D](./roadmap/TB4D-Checklist-Scheduling-Ranges.md) |
| External Editor role/access | [External Editor architecture](./core/13-External-Editor-Authorization.md) → [Current-state audit](./core/02-Current-State-Audit.md) → [TB4E](./roadmap/TB4E-External-Editor-Assigned-Scope-Access.md) |
| Project Stage and Kanban ordering | [Kanban/stage architecture](./core/08-Kanban-Modernization.md) → [TB5A](./roadmap/TB5A-Project-Stage-And-Kanban-Ordering-Contract.md) |
| Kanban interaction modernization | Approved TB5A outcome → [TB5B](./roadmap/TB5B-Kanban-Interaction-Modernization.md) |
| Production Calendar | [Scheduling/Calendar architecture](./core/12-Production-Calendar-And-Checklist-Scheduling.md) → [External Editor architecture](./core/13-External-Editor-Authorization.md) → [Calendar research](./research/Production-Calendar-FullCalendar-Shadcn.md) → [TB5C](./roadmap/TB5C-Production-Calendar.md) |
| Reviewer or release owner | Current `docs/todo.md` → [Migration/verification](./core/09-Migration-Rollback-And-Verification.md) → active tracer-bullet file |
| New planning/implementation agent | Current-main/authority checkpoint above → [Next-agent handoff](./handoff/Next-Agent-Prompt.md) |
| Historical audit only | [`archive/`](./archive/README.md) |
