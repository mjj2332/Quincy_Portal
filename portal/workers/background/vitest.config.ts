...
export default defineConfig({
  ...
  test: { reporters: ["default", requireExecutedTests("workers/background/vitest.config.ts")], testTimeout: TEST_TIMEOUT_MS, hookTimeout: HOOK_TIMEOUT_MS, include: ["test/**/*.test.ts"] },
});
