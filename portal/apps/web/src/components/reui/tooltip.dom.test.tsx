...
/**
 * base-nova's `tooltip.tsx`, vendored whole for #122 (ADR 0005). The z-token conformance edit
 * (`z-50` → `z-[var(--z-popover)]`) is non-behavioural and not re-tested here; this covers the
 * one behavioural-looking edit that a DOM test can actually see — the container normalisation.
 */
...
describe("TooltipContent — portals inside OverlayContainerContext (#122)", () => {
      ...
      await render(
        <OverlayContainerContext.Provider value={container}>
          <Tooltip open>
            ...
            <TooltipContent data-testid="tooltip-content">Hello</TooltipContent>
          </Tooltip>
