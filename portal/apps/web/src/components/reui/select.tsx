...
/**
 * Select primitive — base-nova's `select`, fetched via `npx shadcn@latest add select` into a
 * sandbox (`tmp/ReUI-Test-1`) for #202, registry version matching `@base-ui/react` 1.7.0 in
