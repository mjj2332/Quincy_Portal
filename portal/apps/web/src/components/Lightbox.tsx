...
function CommentThread({ comments, currentUserId, editingCommentId, editingCommentBody, isSaving, disableActions, onReply, onEdit, onEditBodyChange, onCancelEdit, onSaveEdit, depth = 0 }: { comments: ThreadComment[]; currentUserId: string | null; editingCommentId: string | null; editingCommentBody: string; isSaving: boolean; disableActions: boolean; onReply: (id: string) => void; onEdit: (comment: ThreadComment) => void; onEditBodyChange: (body: string) => void; onCancelEdit: () => void; onSaveEdit: () => void; depth?: number }) {
